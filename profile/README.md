...
* [x] 회원가입/로그인, 방 배틀, 실시간 시세, 랭킹, 커뮤니티, 포트폴리오, 백오피스
* [x] KIS 연동 안정화 (WebSocket 재연결, 구독 생명주기 관리)

### 앞으로 할 것

* [ ] Refresh Token 재사용 탐지, 로그아웃 시 Access Token 즉시 무효화
* [ ] 방 참가(join) 동시성 보강
* [ ] 실제 클라우드 배포 (프론트 Vercel류, 백엔드 AWS류)
